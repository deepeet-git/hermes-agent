...
class CredentialPool:
    ...
    def _sync_codex_entry_from_auth_store(self, entry: PooledCredential) -> PooledCredential:
        """Sync a Codex singleton device_code entry from auth.json if tokens differ.
        ...
        Mirrors the Nous/Anthropic resync paths above. Only the singleton
        device_code entry has an auth.json shadow. Manually added OAuth
        entries own independent token pairs and must never adopt it.
        """
